package com.hanyu.chat.ui.view.chat.element.group_bar_chat;

import com.hanyu.chat.ui.util.DateUtil;
...
public class ElementTalk {
     ...
     *
     * @param talkId 对话面板id
     * @param talkType 对话面板类型
     * @param talkName 对话昵称
     * @param talkHead 对话头像
     * @param talkSketch 对话消息
     * @param talkDate 对话时间
     */
